...
| figure | 手办 | 现实中的模型或人偶。 |  |
| full color | 全彩 | 所有正文页面都是彩色的。允许出现少数非故事页的非彩色图片。<br>不适用于无`artbook`标签的`Game CG`、`Western`，有`3d`标签的`Misc`和所有`Image Set`画廊，因为非彩色图片很少出现。<br>![图](https://ehgt.org/2a/02/2a02dc84a762746faca26ed3eb837fe86aa19f8d-231437-1287-1726-jpg_l.jpg) |  |
